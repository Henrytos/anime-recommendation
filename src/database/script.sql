...
VALUES 
(1, 101, 2000, 'Jujutsu Kaisen', 'https://example.com/jjk.jpg', 'Feiticeiros enfrentam maldições com ação intensa.', 'shounen', 'ação'),
(2, 102, 2001, 'Kimi ni Todoke', 'https://example.com/knt.jpg', 'Romance delicado entre adolescentes.', 'shoujo', 'romance');
...
INSERT INTO questions (question_id, fk_quiz_id, title, number)
VALUES 
(DEFAULT, 1000, 'Qual estilo de anime você prefere?', 1),
